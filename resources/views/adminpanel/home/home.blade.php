			...
			<div class="content-main">
				...
				<div class="blank">
					...
					<div class="blank-page">
						<a href="/index/create" class = "btn btn-primary">Add Cover Picture</a>
						<hr>
						<div class="panel panel-default">
							<div class="panel-heading">Cover Image</div>

							<div class="panel-body">
								@if($cover)	<img class = "img-responsive" src="{{url('public/images/'.$cover->coverimage)}}" alt=""><br>
									<h3 class = "text-center">{{$cover->caption}}</h3>
								</div>
							@endif
							@if($cover)
								<div class="panel-footer">
									<form action="/index/{{$cover->id}}" method = "post">
										{{csrf_field	()}}
