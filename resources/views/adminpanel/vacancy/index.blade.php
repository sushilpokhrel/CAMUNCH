            ...
            <div class="blank">
                ...
                <div class="blank-page">
                    <form action="/vacancy/create">
                        <input type="submit" value = "Add new Vacancy">
                    </form>
                    <hr>
                    ...
                    @if($vacancies)
                        <table class = "table table-bordered">
                            ...
                            <tbody>
                            <tr>
                                @foreach($vacancies as $article)
                                    <td><a href="/vacancy/{{$article->id}}">{{$article->title}}</a></td>
                                    <td>{{$article->companyname}}</td>
                                    <td>{{$article->user->name}}</td>
                                    <td>{{$article->lastdate}}</td>
                                    <td><a href="/vacancy/applicants/{{$article->id}}">Show Applicants</a></td>
                                    <td><a href="/vacancy/{{$article->id}}/edit">Edit</a></td>
                                    <td>
