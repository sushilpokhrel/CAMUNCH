...
@section('title')Post Article @endsection
{{--End page title--}}
    ...
    <div class="row">
        ...
        <div class="col s12 l9">
            <div class="row" style="background: #fafafa">
                <h4><i class="material-icons left">mode_edit</i> Article Form</h4>
                        ...
                        <form class="col s12 m12 l12">
                            <div class="row">
                                <div class="input-field col s12">
                                    ...
                                    <label for="title">Article Title Goes Here*</label>
                                </div>
                            </div>
                            <div class="row">
                                <div class="input-field col s12">
                                    <textarea id="introduction" class="materialize-textarea" required></textarea>
                                    <label for="introduction">Introduction Part Goes Here*</label>
                                </div>
                            </div>
                            <div class="row">
                                <div class="input-field col s12">
