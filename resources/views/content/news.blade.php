...
<link rel="stylesheet"  href="{{url('public/public/frontend/css/article.css')}}">
{{--End Stylesheet--}}
@section('body')
    ...
    <div class="row">
        ...
        <div class="col s12 m4 l4">
            <a href="#"><img src="{{url('public/public/images/ads/advert.jpg')}}" class="responsive-img"></a>
        </div>
        <div class="col s12 m4 l4">
            <a href="#"><img src="{{url('public/public/images/ads/advert.jpg')}}" class="responsive-img"></a>
        </div>
            ...
            <div class="row" id="article" style="background: #fafafa;">
                ...
                @foreach($news as $article)
                    <div class="row">
                        ...
                        <p>{!! $small !!}</p>
                        <br><a href="/newsdetails/{{$article->id}}">Read More</a>
                        </p>
                        {{--<li class="right" >
