...
<link rel="stylesheet"  href="{{url('public/public/frontend/css/articledetail.css')}}">
{{--End Stylesheet--}}
@section('body')
    ...
    <div class="row">
        ...
        <div class="col s12 m6 l6">
            <a href="#"><img src="{{url('public/public/images/ads/advert5.jpg')}}" class="responsive-img"></a>
        </div>
        <div class="col s12 m6 l6">
            <a href="#"><img src="{{url('public/public/images/ads/advert5.jpg')}}" class="responsive-img"></a>
        </div>
    ...
    <div class="row">
        ...
        <div class="col s12 m12 l12">
            ...
            {{--<div class="row">--}}
            {{--<a href="#"><img src="{{url('public/public/images/ads/advert1.jpg')}}" class="responsive-img center-block"> </a>--}}
            {{--</div>--}}
        ...
        {{--<div class="row">--}}
        {{--<div class="col s12 m6 l6">--}}
        {{--<a href="#"><img src="{{url('public/public/images/ads/advert4.jpg')}}" class="responsive-img center-block"></a>--}}
        {{--</div>--}}
        ...
        {{--<a href="#"><img src="{{url('public/public/images/ads/advert2.jpg')}}" class="responsive-img"></a>--}}
        {{--</div>--}}
        {{--<div class="section"></div>--}}
        {{--<div class="row" id="ads">--}}
        {{--<a href="#"><img src="{{url('public/public/images/ads/advert3.jpg')}}" class="responsive-img"></a>--}}
        {{--</div>--}}
        {{--<div class="row" id="ads">--}}
        {{--<a href="#"><img src="{{url('public/public/images/ads/advert2.jpg')}}" class="responsive-img"></a>--}}
        {{--</div>--}}
